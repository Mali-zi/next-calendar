export const initEvents = [
  ...
  },
  {
    id: 6,
    title: 'Meeting',
    start: new Date(2024, 2, 12, 10, 30, 0, 0),
    end: new Date(2024, 2, 12, 12, 30, 0, 0),
    desc: 'Pre-meeting meeting, to prepare for the meeting',
  },
  {
    id: 7,
    title: 'Lunch',
    start: new Date(2024, 2, 12, 12, 0, 0, 0),
    end: new Date(2024, 2, 12, 13, 0, 0, 0),
    desc: 'Power lunch',
  },
  {
    id: 8,
    title: 'Meeting',
    start: new Date(2024, 2, 12, 14, 0, 0, 0),
    end: new Date(2024, 2, 12, 15, 0, 0, 0),
  },
  {
    id: 9,
    title: 'Happy Hour',
  ...
  },
  {
    id: 10,
    title: 'Dinner',
    start: new Date(2024, 2, 12, 20, 0, 0, 0),
    end: new Date(2024, 2, 12, 21, 0, 0, 0),
  },
  {
    id: 11,
    title: 'Planning Meeting with Paige',
    start: new Date(2024, 2, 13, 8, 0, 0),
    end: new Date(2024, 2, 13, 10, 30, 0),
  },
  {
    id: 11.1,
    title: 'Inconvenient Conference Call',
    start: new Date(2024, 2, 13, 9, 30, 0),
    end: new Date(2024, 2, 13, 12, 0, 0),
  },
  {
    id: 11.2,
    title: "Project Kickoff - Lou's Shoes",
    start: new Date(2024, 2, 13, 11, 30, 0),
    end: new Date(2024, 2, 13, 14, 0, 0),
  },
  {
    id: 11.3,
    title: 'Quote Follow-up - Tea by Tina',
    start: new Date(2024, 2, 13, 15, 30, 0),
    end: new Date(2024, 2, 13, 16, 0, 0),
  },
  {
    id: 11.4,
    title: 'Quote Follow-up - Tea by Tom',
    start: new Date(2024, 2, 13, 16, 30, 0),
    end: new Date(2024, 2, 13, 17, 0, 0),
  },
  {
    id: 11.5,
    title: 'Quote Follow-up - Tea by Ted',
    start: new Date(2024, 2, 13, 17, 30, 0),
    end: new Date(2024, 2, 13, 18, 0, 0),
  },
  {
    id: 12,
